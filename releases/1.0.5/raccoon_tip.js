...
// *
// * $Date: 2010-09-21 02:04:26 +0100 (Tue, 21 September 2010) $
// *
...
RaccoonTip = (function() {
  ...
  var position = function() {
    ...
    for (pos_index = 0; pos_index < positions.length; pos_index++) {
      raccoon_tip.attr("class", "rt_" + positions[pos_index]);
      
      for (var axis_index = 0; axis_index < 2; axis_index++) {
        switch(positions[pos_index].split("_")[axis_index]) {
          case "top":
    ...
    opts.position = positions[pos_index];
  };
